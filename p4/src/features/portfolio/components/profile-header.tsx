    ...
    <div className="screen-line-bottom flex border-x border-line">
      <div className="shrink-0 border-r border-line">
        <div className="mx-2 my-2">
            <Image
              className="size-30 rounded-full ring-1 ring-border ring-offset-2 ring-offset-background select-none sm:size-40 object-cover"
              alt="Avatar"
              src={USER.avatar}
              width={160}
              height={160}
      ...
      <div className="flex flex-1 flex-col">
        ...
        <div className="border-t border-line">
          <div className="flex items-center gap-2 pl-4">
            <h1 className="-translate-y-px text-5xl font-heading font-semibold tracking-tight">
              {USER.displayName}
            </h1>
