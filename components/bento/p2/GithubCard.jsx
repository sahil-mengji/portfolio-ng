...
const GithubCard = () => {
  ...
  return (
    <HomeBox
      className="flex items-center github"
      outerClassName="github relative group"
    >
      <div className="relative w-full h-full">
        <div className="opacity-100 group-hover:opacity-0 w-full h-full transition-opacity duration-300">
          <GitHubCalendar
            username="sahil-mengji"
        ...
        <a
          href="https://github.com/sahil-mengji"
          className="top-0 left-0 absolute flex justify-center items-center opacity-0 group-hover:opacity-100 w-full h-full transition-opacity duration-300"
        >
          <img
            className="cursor-pointer"
            src="https://streak-stats.demolab.com/?user=sahil-mengji&theme=highcontrast&border=EB545400&background=EB545400&stroke=2F2F2E&ring=AB73FFAB&fire=AB73FF&currStreakNum=FFFFFF&sideNums=FFFFFF&currStreakLabel=AB73FF&dates=8E8E8E&excludeDaysLabel=8E8E8E8F&sideLabels=EBEBEB)](https://git.io/streak-stats"
...
export default GithubCard;
{
  /* <svg
        ...
        viewBox="0 0 200 200"
        fill="#34332a"
        className="top-1/2 left-1/2 -z-10 absolute opacity-[40%] w-[200%] rotate-12 scale-[1.8] group-hover:scale-[2.8] transition-all -translate-x-1/2 -translate-y-[63%] delay-100"
