...
const Navbar = () => {
  ...
  return (
    <>
      ...
      >
        <div className="mx-auto w-full max-w-[800px] hover:scale-[1.05] transition-transform duration-500">
          <div
              ...
              {navItems.map((item, index) => {
                ...
                return (
                  <NavLink
                    key={item.path}
                    to={item.path}
                    className="group relative flex items-center gap-2 px-6 py-4 rounded-full text-gray-400 hover:text-white hover:scale-110 transition-all duration-300 ]"
                  >
                    <IconComponent
                      size={24}
