...
import cult from "/projects/ecell/1.png";
...
function IconCheck({ className, ...props }) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="m229.66 77.66-128 128a8 8 0 1-11.32 0l-56-56a8 1 11.32-11.32L96 188.69 218.34 66.34a8 11.32 11.32Z" />
    </svg>
  );
}
...
function FeatureCard({ bgClass, children, step }) {
  ...
  return (
    ...
    >
      <div
        className={clsx(
          "group relative w-full overflow-hidden rounded-3xl border border-stone-200 border-black/10 bg-gradient-to-b from-neutral-900/90 to-stone-800 transition duration-300 dark:from-neutral-950/90 dark:to-neutral-800/90 dark:border-stone-800",
...
const defaultClasses = {
  step1img1:
    "pointer-events-none w-[50%] border border-stone-200 border-border-100/10 transition-all duration-500 dark:border-border-700/50 rounded-2xl dark:border-stone-800",

  step1img2:
    "pointer-events-none w-[60%] border border-stone-200 border-border-100/10 dark:border-border-700/50 transition-all duration-500 overflow-hidden rounded-2xl dark:border-stone-800",

  step2img1:
    "pointer-events-none w-[50%] border border-stone-200 border-border-100/10 transition-all duration-500 dark:border-border-700 rounded-2xl overflow-hidden dark:border-stone-800",

  step2img2:
    "pointer-events-none w-[40%] border border-stone-200 border-border-100/10 dark:border-border-700 transition-all duration-500 rounded-2xl overflow-hidden dark:border-stone-800",

  step3img:
    "pointer-events-none w-[90%] border border-stone-200 border-border-100/10 dark:border-border-700 rounded-2xl transition-all duration-500 overflow-hidden dark:border-stone-800",
        ...
        case 3:
          ...
          return (
            ...
            >
              <AnimatedStepImage
                alt={image.alt}
                className="pointer-events-none top-[50%] w-[90%] overflow-hidden rounded-2xl border border-stone-200 border-neutral-100/10 md:left-[35px] md:top-[30%] md:w-full dark:border-zinc-700 dark:border-stone-800"
                src={cult}
                preset="fadeInScale"
                delay={0.1}
              />
