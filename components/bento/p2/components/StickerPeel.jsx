...
const StickerPeel = ({
  ...
  return (
    ...
    >
      ...
      <div
        className="relative touch-none sm:touch-auto select-none sticker-container"
        ref={containerRef}
        style={{
      ...
      >
        ...
        <div
          className="top-4 left-2 absolute opacity-40 w-full h-full"
        ...
        <div
          className="left-0 absolute w-full h-full sticker-flap"
          style={flapStyle}
        >
